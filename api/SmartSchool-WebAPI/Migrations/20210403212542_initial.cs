...
namespace SmartSchool_WebAPI.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Disciplinas",
                columns: new[] { "id", "ProfesorId", "Professorid", "nome" },
                values: new object[] { 5, 5, null, "Programação" });

            migrationBuilder.InsertData(
                table: "Disciplinas",
                columns: new[] { "id", "ProfesorId", "Professorid", "nome" },
                values: new object[] { 4, 4, null, "Inglês" });

            migrationBuilder.InsertData(
                table: "Disciplinas",
                columns: new[] { "id", "ProfesorId", "Professorid", "nome" },
                values: new object[] { 2, 2, null, "Física" });

            migrationBuilder.InsertData(
                table: "Disciplinas",
                columns: new[] { "id", "ProfesorId", "Professorid", "nome" },
                values: new object[] { 1, 1, null, "Matemática" });

            migrationBuilder.InsertData(
                table: "Disciplinas",
                columns: new[] { "id", "ProfesorId", "Professorid", "nome" },
                values: new object[] { 3, 3, null, "Português" });
